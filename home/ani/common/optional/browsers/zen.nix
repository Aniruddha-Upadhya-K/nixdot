...

{
  ...
  programs.zen-browser = {
    ...
    in {
      ...
      DisablePocket =
        true; # save webs for later reading DisableTelemetry = true;
      ...
      ExtensionSettings = (let
        extension = uuid: shortUrl: {
          ...
          value = {
            install_url =
              "https://addons.mozilla.org/firefox/downloads/latest/${shortUrl}/latest.xpi";
    ...
    profiles.main = {
      ...
      settings = {
        ...
        "layout.css.devPixelsPerPx" = if !hostSpec.isDarwin then
          0.875
        else
          -1.0; # Important, otherwise everything is too much zoomed in linux
